<?php
/**
 *    xlsx_excel php class v0.8.19
 *    MS Excel 2007 workbooks reader
 *
 * Copyright (c) 2012 - 2020 xlsx_excel
 *
 * @category   xlsx_excel
 * @package    xlsx_excel
 * @copyright  Copyright (c) 2012 - 2020 xlsx_excel (https://github.com/ipxxx999?tab=repositories)
 * @license    MIT
 * @version    0.8.19
 */
 ...
 *
 * Example 1:
 * if ( $xlsx = xlsx_excel::parse('book.xlsx') ) {
 *   print_r( $xlsx->rows() );
 * } else {
 *   echo xlsx_excel::parseError();
 * }
 *
 ...
 *
 * Example 3: rowsEx
 * $xlsx = xlsx_excel::parse('book.xlsx');
 * print_r( $xlsx->rowsEx() );
 *
 ...
 *
 * Example 8: read data
 * if ( $xlsx = xlsx_excel::parseData( file_get_contents('http://www.example.com/example.xlsx') ) ) {
