...
require_once 'xlsx_excel.php';
$firstrow=0; 
if ( $xlsx = xlsx_excel::parse($_FILES["fileToUpload"]["tmp_name"]) ) {
...
<html>
<html lang="en">
<title>XLSX Excel to CSV</title>
<meta charset="UTF-8">
<body>
<form action="" method="post" enctype="multipart/form-data">
  Cargue un archivo xlsx compatible:
  <input type="file" name="fileToUpload" id="fileToUpload">
  <input type="submit" value="Convertir Excel XLSX" name="submit">
</form>
</body>
</html>
<?php
